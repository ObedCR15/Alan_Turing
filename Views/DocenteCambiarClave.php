...
require_once "../Controllers/DocenteCambiarClaveController.php";

$controller = new DocenteCambiarClaveController($pdo);

if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    $exito = $controller->cambiarClave($_POST, $_SESSION['docente_id']);
}
?>
